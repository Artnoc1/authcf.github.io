$(function() {
  ...
  CMS.init({
    ...
    siteTagline: 'Identity management',

    // Email address
    siteEmail: 'admin@auth.cf',
    ...
    // Navigation items
    siteNavItems: [
      { name: 'Github', href: 'https://github.com/mmacedoeu', newWindow: false},
      { name: 'About'}
    ],
    ...
    githubUserSettings: {
      username: 'mmacedoeu',
      repo: 'https://github.com/authcf/authcf.github.io'
    },
